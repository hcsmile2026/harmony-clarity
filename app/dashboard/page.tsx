    ...
    <AppShell>
      ...
      <div className="mb-8">
        {(credits === null || credits > 0) ? (
          ...
          <div className="rounded-xl p-4 text-center flex flex-col items-center gap-3" style={{ backgroundColor: "#FEF3C7", border: "1px solid #F59E0B" }}>
            ...
            {sessions.map((session) => (
              <div key={session.id} onClick={function(){window.location.href="/view-blueprint?session="+session.id}} style={{cursor:"pointer"}}><ClarityCard>
                <div className="flex items-start justify-between gap-4">
                  ...
                  {(session.session_status || session.status) === "closed" && <span className="text-xs font-medium mr-1" style={{ color: "var(--hcb-action-primary)" }}>View &rarr;</span>}
                  <span
